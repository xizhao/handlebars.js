...
minimal_deps = %w(browser-prefix base compiler/parser compiler/base compiler/ast utils compiler/source-buffer compiler/compiler compiler/javascript-compiler runtime browser-suffix).map do |file|
